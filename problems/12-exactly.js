...
function exactly(array, num, cb) {
  // should return a boolean indicating whether or not there are exactly `number`
  // elements of the array that return true when passed into the callback
  let elCounter = 0;
  for(let el of array) {
      if(cb(el)) {
        elCounter++;
