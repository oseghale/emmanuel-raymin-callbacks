...
function chainMap(val, ...callbacks) {
  // The function chainMap uses the rest parameter ...callbacks to collect all the passed callbacks into an array.
  // It then iterates over each callback, updating the value using that callback, and finally returns the modified value
  // should return the final result of passing the value through all of the given callbacks
