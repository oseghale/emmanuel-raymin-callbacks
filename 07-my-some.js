...
function mySome(array, cb) {
    //should call the callback for each element of the array, passing in
    // the element and its index. The function should return a boolean
    // indicating whether or not at least one element of the array returns true when passed into the callback
    let bool = false;
