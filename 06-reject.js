...
function reject(array, cb) {
  // should call the callback for each element of the array, passing in the
  // element. The function should return a new array
  // containing elements of the original array that result in false when given to the callback.
  let newArr = [];
